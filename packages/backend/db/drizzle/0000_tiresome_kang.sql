...
CREATE TABLE "phone" (
	...
	"buy_cost" numeric(2, 12) NOT NULL,
...
CREATE TABLE "repair" (
	...
	"client_cost" numeric(2, 12) NOT NULL,
	"internal_cost" numeric(2, 12) NOT NULL,
...
CREATE TABLE "sale" (
	...
	"datetime" timestamp NOT NULL,
	"total_amount" numeric(2, 12) NOT NULL,
	"payment_method" varchar(50) NOT NULL,
	"debt" boolean DEFAULT false NOT NULL,
	"debt_amount" numeric(2, 12) NOT NULL,
	"client_id" integer,
	"seller_id" integer,
	"device_id" integer NOT NULL
);
